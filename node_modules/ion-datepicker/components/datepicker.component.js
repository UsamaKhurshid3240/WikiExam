...
var DatePickerComponent = (function () {
    ...
    DatePickerComponent.prototype.nextMonth = function () {
        ...
        if (!maxTestDate || maxTestDate >= testDate) {
            ...
            var availableDates = this.DatepickerService.getMonthAvailableDays(testDate, this.config.disabledDates);
            if (availableDates.length === 0) {
                this.tempDate = testDate;
                this.nextMonth();
                return;
            }
            if (-1 === availableDates.findIndex(function (date) { return date.getDate() === _this.tempDate.getDate(); })) {
